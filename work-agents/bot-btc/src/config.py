"""Configuration sûre et valeurs par défaut du simulateur BTC.
...
DEFAULT_CONFIG: Dict[str, Any] = {
    ...
    "backtest": {
        "interval": "1d",
        "data_file": "data/btc_history.csv",
        "public_data": False,
        "warmup_bars": 26,
    },
}
...
def validate_config(config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if not symbol.startswith("BTC"):
        raise ValueError("Cette instance ne trade que BTC spot")
