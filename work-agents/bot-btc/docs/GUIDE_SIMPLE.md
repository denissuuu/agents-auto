# Guide simple — BTC simulé

Ce bot est un exercice BTC spot avec 1 000 EUR fictifs. Il n'utilise aucune clé API et n'envoie aucun ordre.

## Voir un tick

```bash
cd /Users/juliamenard/Desktop/denis-code/work-agents/bot-btc
PYTHONPATH=src python3 src/paper.py --once
```

La sortie indique le prix public, le cash, la quantité BTC, la valeur, les frais et les P&L. Le prix est lu en `BTCEUR` (klines publiques Binance, lecture seule) ; il n'est pas un ordre réel.
