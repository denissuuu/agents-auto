# Règles projet — denis-code

- Agent par défaut : `orchestrator`. Il délègue à `chef-projet` (cadrage) puis `dev` (implémentation).
- Modèle unique : `opencode/big-pickle` (gratuit). Ne jamais proposer un autre modèle.
